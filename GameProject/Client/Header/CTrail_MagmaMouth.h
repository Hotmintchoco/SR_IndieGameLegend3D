...
//}
//
//class CTrail_MagmaMouth : public CTrail
//{
//protected:
...
//	static CTrail_MagmaMouth* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3(&vTrailPoint)[4], const D3DXCOLOR(&eColor)[4], const _float& fLifeTime);
//
//private:
