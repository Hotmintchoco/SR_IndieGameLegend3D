...
void CPlayer::Set_OnTerrain(const _float& fTimeDelta)
{
    ...
    if (vPos.y < fY + 1.f) // KEY_INPUT������ �̵��� ���� ���� ����
    {
        vPos.y = fY + 1.f;
        m_pTransformCom->Set_Pos(vPos.x, vPos.y, vPos.z);
    }
    else if ((m_iJumpState == JUMP_NOT) && (vPos.y > fY + 1.f)) // ���ĸ� �������� �Ǵ� �������� ��������
    {
        _float fClampDelta = 0.05f; // ���� ��翡�� ���������ϴ� ��� ����Ŭ���� ��ų ����
        if (vPos.y - (fY + 1.f) < fClampDelta)
        {
            vPos.y = fY + 1.f;
            m_pTransformCom->Set_Pos(vPos.x, vPos.y, vPos.z); // ����Ŭ����
        }
        else
        {
