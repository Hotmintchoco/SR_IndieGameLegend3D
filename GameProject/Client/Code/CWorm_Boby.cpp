...
CWorm_Boby::CWorm_Boby(LPDIRECT3DDEVICE9 pGraphicDev)
    : CMonster(pGraphicDev)
{
}


CWorm_Boby::~CWorm_Boby()
{
}

HRESULT CWorm_Boby::Ready_GameObject()
{
...
void CWorm_Boby::Render_GameObject()
{
...
HRESULT CWorm_Boby::Add_Component()
{
...
//CWorm_Boby* CWorm_Boby::Create(LPDIRECT3DDEVICE9 pGraphicDev)
//{
